...
![Level](https://img.shields.io/badge/Internship-Level_1_%26_2-blue?style=for-the-badge)
...
- [Level 1 Tasks](#level-1-tasks)
  - [Task 1: Temperature Converter](#level-1-task-1-temperature-converter)
  - [Task 2: Palindrome Checker](#level-1-task-2-palindrome-checker)
  - [Task 3: Student Grade Calculator](#level-1-task-3-student-grade-calculator)
  - [Task 4: Password Generator](#level-1-task-4-password-generator)
- [Level 2 Tasks](#level-2-tasks)
  - [Task 1: Password Strength Checker](#level-2-task-1-password-strength-checker)
  - [Task 2: File Encryption/Decryption](#level-2-task-2-file-encryptiondecryption)
  - [Task 3: Console Chat Application](#level-2-task-3-console-chat-application)
...
**File**: [`L1task1.java`](file:///c:/cognifyz/L1task1.java)
...
**File**: [`L1task2.java`](file:///c:/cognifyz/L1task2.java)
...
**File**: [`L1task3.java`](file:///c:/cognifyz/L1task3.java)
...
**File**: [`L1task4.java`](file:///c:/cognifyz/L1task4.java)
...
**File**: [`L2task1.java`](file:///c:/cognifyz/L2task1.java)
...
**File**: [`L2task2.java`](file:///c:/cognifyz/L2task2.java)
...
**File**: [`L2task3.java`](file:///c:/cognifyz/L2task3.java)
